            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="title-all text-center">
                        <h1>Thư Viện Của Chúng Tôi</h1>
                        <p>Khám phá thế giới đầy màu sắc và tươi mới trong thư viện đa dạng của chúng tôi</p>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-12">
                    <div class="special-menu text-center">
                        <div class="button-group filter-button-group">
                            ...
                            <button data-filter=".bulbs">Hạt</button>
                            <button data-filter=".fruits">Trái cây</button>
							<button data-filter=".podded-vegetables">Rau củ</button>
							<button data-filter=".root-and-tuberous">Ngũ cốc</button>
                        </div>
                    </div>
                </div>
            </div>
